...
calcuim_low = filter(d_l,calcuim_trace);
delay_l = mean(grpdelay(d_l));
calcuim_mod_l = [calcuim_low(delay_l:end); mean(calcuim_trace(end-delay_l+1:end))*ones(delay_l-1,1)] ;

Fsth =0.8;%CutoffFrequency
